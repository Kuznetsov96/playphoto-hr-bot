...
export const FIRST_SHIFT_ONBOARDING_STEPS: FirstShiftOnboardingStepConfig[] = [
    ...
    },
    {
        ...
        prompt: "Підключи ноутбук до мережі, увімкни його кнопкою живлення, натисни скрипт START на робочому столі, перевір робочий стіл і протри ноутбук серветкою. Перейди в Google Chrome, обери своє прізвище в робочій таблиці й подивись, як вона заповнюється: продали — внесли позицію одразу. Надішли скрін робочого столу.",
    ...
    },
    {
        ...
        prompt: "Підключи принтер до мережі й ноутбука USB-шнуром, правильно встав папір 10x15 і перевір, що на принтері нічого не лежить. Надішли фото, як стоїть папір у принтері.",
        inputType: "PHOTO",
        requiresMentorApproval: true,
    },
    {
