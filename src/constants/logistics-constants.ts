export const NP_LOCATIONS_MAP = [
    ...
    { name: 'Карамель Коломия', city: 'Коломия', npPoints: ['36870'] },
    { name: 'Карамель Шептицький (Червоноград)', city: 'Шептицький', npPoints: ['36303'] },
    { name: 'Fly Kids Рівне', city: 'Рівне', npPoints: ['19', '55207'] },
    { name: 'Fantasy Town', city: 'Черкаси', npPoints: ['32583'] },
    { name: 'Smile Park Kharkiv', city: 'Харків', npPoints: ['23410'] },
    { name: 'Karamel Sambir', city: 'Самбір', npPoints: ['2', '36699'] },
