...
export const CANDIDATE_TEXTS = {
    ...
    "worker-abandoned-screening": "<b>Анкету майже завершено! ✨</b>\n\nТвій шлях у PlayPhoto розпочато. Залишилося ще кілька кроків, щоб ми могли познайомитися ближче. Тисни кнопку нижче, щоб продовжити з того місця, де ми зупинилися! 📸",
