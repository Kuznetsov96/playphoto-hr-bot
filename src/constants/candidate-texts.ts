...
export const CANDIDATE_TEXTS = {
    ...
    "candidate-rich-message-plain-text-required": "Бачу повідомлення зі складним форматуванням. Для полів анкети надішли, будь ласка, відповідь звичайним текстом без rich-редактора. 🌸",
