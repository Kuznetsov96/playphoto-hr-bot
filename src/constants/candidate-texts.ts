...
export const CANDIDATE_TEXTS = {
    ...
    "candidate-training-completed-quiz": (_firstName: string) => `✅ <b>NDA підписано!</b>\n\nПривіт! ✨ Тепер ти можеш переходити до тестування. ✨`,
