...
export const CANDIDATE_TEXTS = {
    ...
    // --- 7. UI BUTTONS ---
    /**
     * Емодзі в текстах повідомлень не використовуються взагалі — текст читають,
     * і значок у ньому лише відволікає. На кнопках лишився єдиний випадок, де
     * емодзі працює як значок, а не як прикраса: логотипи майданчиків у списку
     * джерел. Кнопку сканують поглядом, і впізнаваний значок Instagram чи OLX
     * справді пришвидшує вибір — на відміну від 👗/👔 як позначення статі
     * (стереотип), 💍 на відповіді про пірсинг чи 🤷‍♀️ на варіанті «Інше»,
     * які читалися як кепкування з того, хто його обрав.
     *
