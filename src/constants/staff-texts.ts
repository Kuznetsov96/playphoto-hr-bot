...
(City or spot for filtering)`,
  ...
  "schedule-notif-kind-added": `➕ Додано зміну`,
  "schedule-notif-kind-removed": `➖ Знято зміну`,
  "schedule-notif-kind-moved": `🔀 Перенесено зміну`,
  "schedule-notif-kind-reassigned": `🔄 Змінено локацію або фотографа`,
  ...
  "schedule-notif-details-unknown": `деталі уточнюються`,
  ...
  "schedule-notif-footer": `Загляни у «Мій графік», щоб побачити актуальний розклад 📸`,
