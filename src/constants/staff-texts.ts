export const STAFF_TEXTS = {
  /**
   * Доступ до закритого каналу. Посилання персональне й одноразове, але людині
   * це знати не треба — вона просто хоче потрапити в канал, тож механіка з
   * тексту прибрана.
   */
  "channel-invite-welcome": `<b>Вітаємо в команді PlayPhoto</b>\n\nОсь ваше посилання на канал команди.`,
  "channel-invite-back": `<b>З поверненням</b>\n\nОсь ваше посилання на канал команди.`,
  "channel-invite-link": `Ваше посилання на канал команди.`,
  "channel-invite-denied": `Доступ до каналу відкривається після оформлення.`,
  /** Масове поновлення доступу після зміни налаштувань каналу. */
  "channel-invite-restored": `<b>Доступ поновлено</b>\n\nОсь ваше нове посилання на канал команди.`,
  "channel-btn-join": `Приєднатися`,
  "channel-btn-get-link": `Канал команди`,
