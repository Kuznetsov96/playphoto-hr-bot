...
ACCESS_REVOCATIONS_ENABLED="${ACCESS_REVOCATIONS_ENABLED:-false}"
...
if [[ "$ACCESS_REVOCATIONS_ENABLED" != "true" && "$ACCESS_REVOCATIONS_ENABLED" != "false" ]]; then
  echo "ACCESS_REVOCATIONS_ENABLED must be true or false." >&2
  exit 1
fi
...
set_env ACCESS_REVOCATIONS_ENABLED "$ACCESS_REVOCATIONS_ENABLED"
