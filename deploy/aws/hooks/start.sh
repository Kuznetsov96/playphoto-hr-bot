...
export AWS_REPLACEMENTS_SHADOW_ENABLED AWS_REPLACEMENTS_CANONICAL_ENABLED AWS_REMINDERS_CANONICAL_READ_ENABLED AWS_PREFERENCES_CANONICAL_WRITE_ENABLED
